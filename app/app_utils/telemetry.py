...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=cyberpunk-solo-rpg,service.version={commit_sha}",
        )
    ...
    try:
        ...
        logging.warning("Google Cloud Default Credentials not found. Skipping OpenTelemetry exporter setup.")
